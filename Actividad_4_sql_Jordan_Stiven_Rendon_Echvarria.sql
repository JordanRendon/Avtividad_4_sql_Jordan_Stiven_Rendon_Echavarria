...
-- Volcando estructura para tabla lugares_en_el_mundo.cities_country_continents
DROP TABLE IF EXISTS `cities_country_continents`;
CREATE TABLE IF NOT EXISTS `cities_country_continents` (
  `id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
  `cities_id` tinyint(4) NOT NULL,
  `country_id` tinyint(4) NOT NULL,
  `continent_id` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla lugares_en_el_mundo.cities_country_continents: ~0 rows (aproximadamente)
DELETE FROM `cities_country_continents`;
INSERT INTO `cities_country_continents` (`id`, `cities_id`, `country_id`, `continent_id`) VALUES
	(1, 1, 1, 1),
	(2, 2, 1, 1),
	(3, 3, 2, 1),
	(4, 4, 3, 1),
...
-- Volcando estructura para tabla lugares_en_el_mundo.country
...
-- Volcando datos para la tabla lugares_en_el_mundo.country: ~10 rows (aproximadamente)
DELETE FROM `country`;
